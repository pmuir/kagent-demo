...
_MCP_SERVERS = [
    {
        ...
        "type": "remote",
        "url": "http://agentgateway:8080/mcp",
    },
]
...
def get_mcp_tools(
    ...
    Args:
        ...
        server_filters: Optional dict mapping server names to ToolPredicates for per-server filtering.
        global_filter: Optional ToolPredicate to apply to all servers (overridden by server_filters).
